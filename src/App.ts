...
import { Engine, Scene, ArcRotateCamera, Vector3, HemisphericLight, Mesh, MeshBuilder, Color3, Color4, FreeCamera, Matrix, Quaternion, StandardMaterial, PointLight, ShadowGenerator } from "@babylonjs/core";
...
export class App {
    ...
    private async _goToGame() {
        ...
        //--INPUT--
        this._input = new PlayerInput(this._scene); //detect keyboard/mobile inputs
    }
